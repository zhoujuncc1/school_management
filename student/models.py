...
class Student(models.Model):
    ...
    birthday = models.DateField('生日',blank=True, default='')
    ...
    start_date = models.DateField('开始日期',blank=True, default='')
    end_date = models.DateField('结束日期',blank=True, default='')
    ...
    matric_date = models.DateField('入学日期',blank=True, default='')
...
class StudentForm(ModelForm):
    ...
    class Meta:
        model=Student
        fields=["district","name","birthday","people","school","home_address","mother_name","mother_work","father_name","father_work","start_date","end_date","class_name","skill_level","wechat","qq","matric_date","remarks"]
        widgets = {
